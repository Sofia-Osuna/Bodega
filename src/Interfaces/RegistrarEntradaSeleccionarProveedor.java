 ...
 * @author carla
 */
public class RegistrarEntradaSeleccionarProveedor extends javax.swing.JFrame {

    /**
     * Creates new form RegistrarEntradaSeleccionarProveedor
     */
    public RegistrarEntradaSeleccionarProveedor() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Registro de entrada(seleccion de proveedor)");
        ...
        jLabel5.setText("Produccto");

        jLabel6.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jLabel6.setText("Cantidad:");

        jTextField4.setBackground(new java.awt.Color(42, 138, 127));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrarEntradaSeleccionarProveedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistrarEntradaSeleccionarProveedor().setVisible(true);
            }
        });
    }
