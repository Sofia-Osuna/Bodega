...
public class ReporteDiario extends javax.swing.JFrame {
    ...
    try {
        ...
        String sql = "SELECT c.nombre_categoria, COUNT(p.id_producto) AS prod_registrados, SUM(p.precio*p.stock) AS total_cat FROM categoria c INNER JOIN producto p ON c.id_categoria=p.id_categoria WHERE c.estatus='A' GROUP BY c.nombre_categoria;";
